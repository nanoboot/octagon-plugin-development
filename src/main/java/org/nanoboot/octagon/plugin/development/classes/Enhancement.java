 ...
 * @since 0.1.0
 */
public final class Enhancement extends AbstractDevelopmentTask {
      ...
      if (SCHEMA == null) {
         ...
         for (EntityAttribute e : SCHEMA) {
            if (e.getName().equals("parentId")) {
               ...
               e.setNamedList("getEnhancementsForProduct");
   ...
   public void validateDelete() {
      ...
      throw new OctagonException(Enhancement.class.getSimpleName() + " cannot be deleted, because of possible references in Git commit messages.");
   }
   @Override
