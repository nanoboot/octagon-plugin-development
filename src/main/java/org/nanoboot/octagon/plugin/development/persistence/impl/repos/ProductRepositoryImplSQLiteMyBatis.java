...
import org.nanoboot.octagon.plugin.development.persistence.api.ProductRepository;
 ...
 * @since 0.1.0
 */
public class ProductRepositoryImplSQLiteMyBatis extends RepositoryImpl<Product> implements ProductRepository {

    public ProductRepositoryImplSQLiteMyBatis(MapperApi<Product> mapper, Class type) {
        super(mapper, type);
    }
}
