 ...
 * @since 0.1.0
 */
public final class Story extends AbstractDevelopmentTask {
        ...
        if (SCHEMA == null) {
            ...
            for (EntityAttribute e : SCHEMA) {
                if (e.getName().equals("parentId")) {
                    ...
                    e.setNamedList("getEpicsForProduct");
    ...
    public String[] getRelatedActionsForEntity() {
        return new String[]{
                "Add Task:create?className=DevTask&productId=(#preselectionProperty)&parentId=",
                "List tasks:list?className=DevTask&filter_parentId=",
        };
    }
}
