...
import org.nanoboot.octagon.plugin.development.persistence.api.DevTaskRepository;
 ...
 * @since 0.1.0
 */
public class DevTaskRepositoryImplSQLiteMyBatis extends RepositoryImpl<DevTask> implements DevTaskRepository {

    public DevTaskRepositoryImplSQLiteMyBatis(MapperApi<DevTask> mapper, Class type) {
        super(mapper, type);
    }
}
