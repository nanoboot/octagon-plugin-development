...
import org.nanoboot.octagon.plugin.development.persistence.api.DevSubTaskRepository;
 ...
 * @since 0.1.0
 */
public class DevSubTaskRepositoryImplSQLiteMyBatis extends RepositoryImpl<DevSubTask> implements DevSubTaskRepository {

    public DevSubTaskRepositoryImplSQLiteMyBatis(MapperApi<DevSubTask> mapper, Class type) {
        super(mapper, type);
    }
}
