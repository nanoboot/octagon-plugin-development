 ...
 * @since 0.1.0
 */
public final class Problem extends AbstractDevelopmentTask {
      ...
      if (SCHEMA == null) {
         ...
         for (EntityAttribute e : SCHEMA) {
            if (e.getName().equals("parentId")) {
               ...
               e.setNamedList("getProblemsForProduct");
   ...
   public void validateDelete() {
      ...
      throw new OctagonException(Problem.class.getSimpleName() + " cannot be deleted, because once it is created, it must stay there.");
   }
   @Override
