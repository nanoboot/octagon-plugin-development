...
import org.nanoboot.octagon.plugin.development.persistence.api.ProblemRepository;
 ...
 * @since 0.1.0
 */
public class ProblemRepositoryImplSQLiteMyBatis extends RepositoryImpl<Problem> implements ProblemRepository {

    public ProblemRepositoryImplSQLiteMyBatis(MapperApi<Problem> mapper, Class type) {
        super(mapper, type);
    }
}
