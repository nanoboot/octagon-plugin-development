...
import org.nanoboot.octagon.plugin.development.persistence.api.ProposalRepository;
 ...
 * @since 0.1.0
 */
public class ProposalRepositoryImplSQLiteMyBatis extends RepositoryImpl<Proposal> implements ProposalRepository {

    public ProposalRepositoryImplSQLiteMyBatis(MapperApi<Proposal> mapper, Class type) {
        super(mapper, type);
    }
}
