...
import org.nanoboot.octagon.plugin.development.persistence.api.EpicRepository;
 ...
 * @since 0.1.0
 */
public class EpicRepositoryImplSQLiteMyBatis extends RepositoryImpl<Epic> implements EpicRepository {

    public EpicRepositoryImplSQLiteMyBatis(MapperApi<Epic> mapper, Class type) {
        super(mapper, type);
    }
}
