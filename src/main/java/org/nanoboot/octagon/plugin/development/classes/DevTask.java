 ...
 * @since 0.1.0
 */
public final class DevTask extends AbstractDevelopmentTask {
        ...
        if (SCHEMA == null) {
            ...
            for (EntityAttribute e : SCHEMA) {
                if (e.getName().equals("parentId")) {
                    ...
                    e.setNamedList("getStoriesForProduct");
    ...
    public String[] getRelatedListsForEntity() {
        return new String[]{
                "getDevSubTasksForDevTask"
        };
    }

    public String[] getRelatedActionsForEntity() {
        return new String[]{
                "Add subtask:create?className=DevSubTask&productId=(#preselectionProperty)&parentId=",
                "List subtasks:list?className=DevSubTask&filter_parentId=",
        };
    }
    public void validateDelete() {
        super.validateDelete();
        throw new OctagonException(DevTask.class.getSimpleName() + " cannot be deleted, because of possible references in Git commit messages.");
    }
}
