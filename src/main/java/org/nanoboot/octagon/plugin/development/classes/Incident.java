 ...
 * @since 0.1.0
 */
public final class Incident extends AbstractDevelopmentTask {
      ...
      if (SCHEMA == null) {
         ...
         for (EntityAttribute e : SCHEMA) {
            if (e.getName().equals("parentId")) {
               ...
               e.setNamedList("getIncidentsForProduct");
   ...
   public void validateDelete() {
      ...
      throw new OctagonException(Incident.class.getSimpleName() + " cannot be deleted, because once it is created, it must stay there.");
   }
   @Override
