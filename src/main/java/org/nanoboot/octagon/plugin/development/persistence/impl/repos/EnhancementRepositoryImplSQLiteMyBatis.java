...
import org.nanoboot.octagon.plugin.development.persistence.api.EnhancementRepository;
 ...
 * @since 0.1.0
 */
public class EnhancementRepositoryImplSQLiteMyBatis extends RepositoryImpl<Enhancement> implements EnhancementRepository {

    public EnhancementRepositoryImplSQLiteMyBatis(MapperApi<Enhancement> mapper, Class type) {
        super(mapper, type);
    }
}
