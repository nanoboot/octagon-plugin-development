...
import org.nanoboot.octagon.plugin.development.persistence.api.NewFeatureRepository;
 ...
 * @since 0.1.0
 */
public class NewFeatureRepositoryImplSQLiteMyBatis extends RepositoryImpl<NewFeature> implements NewFeatureRepository {

    public NewFeatureRepositoryImplSQLiteMyBatis(MapperApi<NewFeature> mapper, Class type) {
        super(mapper, type);
    }
}
