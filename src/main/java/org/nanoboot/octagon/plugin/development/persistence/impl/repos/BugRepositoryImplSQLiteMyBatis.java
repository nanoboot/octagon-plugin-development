...
import org.nanoboot.octagon.plugin.development.persistence.api.BugRepository;
 ...
 * @since 0.1.0
 */
public class BugRepositoryImplSQLiteMyBatis extends RepositoryImpl<Bug> implements BugRepository {

    public BugRepositoryImplSQLiteMyBatis(MapperApi<Bug> mapper, Class type) {
        super(mapper, type);
    }
}
