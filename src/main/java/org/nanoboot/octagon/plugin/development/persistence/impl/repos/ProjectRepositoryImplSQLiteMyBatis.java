...
import org.nanoboot.octagon.plugin.development.persistence.api.ProjectRepository;
 ...
 * @since 0.1.0
 */
public class ProjectRepositoryImplSQLiteMyBatis extends RepositoryImpl<Project> implements ProjectRepository {

    public ProjectRepositoryImplSQLiteMyBatis(MapperApi<Project> mapper, Class type) {
        super(mapper, type);
    }
}
