...
import org.nanoboot.octagon.plugin.development.persistence.api.IncidentRepository;
 ...
 * @since 0.1.0
 */
public class IncidentRepositoryImplSQLiteMyBatis extends RepositoryImpl<Incident> implements IncidentRepository {

    public IncidentRepositoryImplSQLiteMyBatis(MapperApi<Incident> mapper, Class type) {
        super(mapper, type);
    }
}
